        ...
        <div className="col-lg-12">
          ...
          <div className="card">
            <div className="card-image">
              <img className="img-fluid" src="assets/images/description-1.png" alt="alternative" />
            </div>
          ...
          <div className="card">
            <div className="card-image">
              <img className="img-fluid" src="assets/images/description-2.png" alt="alternative" />
            </div>
            <div className="card-body">
          ...
          <div className="card">
            <div className="card-image">
              <img className="img-fluid" src="assets/images/description-3.png" alt="alternative" />
            </div>
            <div className="card-body">
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <ul className="nav nav-tabs" id="argoTabs" role="tablist">
            <li className="nav-item">
              <a className="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><i className="fas fa-list" />List Builder</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false"><i className="fas fa-envelope-open-text" />Campaigns</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false"><i className="fas fa-chart-bar" />Analytics</a>
            </li>
          </ul>
          {/* end of tabs links */}
          {/* Tabs Content */}
          <div className="tab-content" id="argoTabsContent">
            ...
            <div className="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
              <div className="row">
                <div className="col-lg-6">
                  <div className="image-container">
                    <img className="img-fluid" src="assets/images/features-1.png" alt="alternative" />
                  </div> {/* end of image-container */}
                </div> {/* end of col */}
                <div className="col-lg-6">
                  <div className="text-container">
            ...
            <div className="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
              <div className="row">
                <div className="col-lg-6">
                  <div className="image-container">
                    <img className="img-fluid" src="assets/images/features-2.png" alt="alternative" />
                  </div> {/* end of image-container */}
                </div> {/* end of col */}
                <div className="col-lg-6">
                  <div className="text-container">
            ...
            <div className="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
              <div className="row">
                <div className="col-lg-6">
                  <div className="image-container">
                    <img className="img-fluid" src="assets/images/features-3.png" alt="alternative" />
                  </div> {/* end of image-container */}
                </div> {/* end of col */}
                <div className="col-lg-6">
                  <div className="text-container">
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-8">
          <div className="image-container">
            <img className="img-fluid" src="assets/images/details-lightbox.png" alt="alternative" />
          </div> {/* end of image-container */}
        </div> {/* end of col */}
        <div className="col-lg-4">
          ...
          <ul className="list-unstyled li-space-lg">
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">List building framework</div>
            </li>
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">Easy database browsing</div>
            </li>
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">User administration</div>
            </li>
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">Automate user signup</div>
            </li>
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">Quick formatting tools</div>
            </li>
            <li className="media">
              <i className="fas fa-square" /><div className="media-body">Fast email checking</div>
            </li>
          </ul>
  ...
  <div id="details" className="basic-1">
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-6">
          <div className="image-container">
            <img className="img-fluid" src="assets/images/details.png" alt="alternative" />
          </div> {/* end of image-container */}
        </div> {/* end of col */}
      </div> {/* end of row */}
    </div> {/* end of container */}
          ...
          <div className="image-container">
            <div className="video-wrapper">
              <a className="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                <img className="img-fluid" src="assets/images/video-image.png" alt="alternative" />
        ...
        <div className="col-lg-12">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <ul className="list-unstyled li-space-lg">
                <li className="media">
                  <i className="fas fa-check" /><div className="media-body">Email Marketing Module</div>
                </li>
                <li className="media">
                  <i className="fas fa-check" /><div className="media-body">User Control Management</div>
                </li>
                <li className="media">
                  <i className="fas fa-times" /><div className="media-body">List Building And Cleaning</div>
                </li>
                <li className="media">
                  <i className="fas fa-times" /><div className="media-body">Collected Data Reports</div>
                </li>
                <li className="media">
                  <i className="fas fa-times" /><div className="media-body">Planning And Evaluation</div>
                </li>
              </ul>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <ul className="list-unstyled li-space-lg">
                ...
                <li className="media">
                  <i className="fas fa-check" /><div className="media-body">List Building And Cleaning</div>
                </li>
                <li className="media">
                  <i className="fas fa-times" /><div className="media-body">Collected Data Reports</div>
                </li>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <ul className="list-unstyled li-space-lg">
                ...
                <li className="media">
                  <i className="fas fa-check" /><div className="media-body">Collected Data Reports</div>
                </li>
                <li className="media">
                  <i className="fas fa-check" /><div className="media-body">Planning And Evaluation</div>
                </li>
              </ul>
              <div className="button-wrapper">
                <a className="btn-solid-reg page-scroll" href="sign-up.html">SIGN UP</a>
          ...
          <div className="text-container">
            ...
            <form id="newsletterForm" data-toggle="validator" data-focus="false">
              ...
              <div className="form-group checkbox">
                <input type="checkbox" id="nterms" defaultValue="Agreed-to-Terms" required />I've read and agree to Tivo's written <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
                <div className="help-block with-errors" />
              </div>
              <div className="form-group">
          ...
          <div className="footer-col last">
            ...
            <ul className="list-unstyled li-space-lg p-small">
              ...
              <li className="media">
                ...
                <div className="media-body"><a className="white" href="mailto:contact@tivo.com">contact@tivo.com</a> <i className="fas fa-globe" /><a className="white" href="#your-link">www.tivo.com</a></div>
              </li>
            </ul>
          </div> 
        </div> {/* end of col */}
